...
${this.wrapWithColor("✉", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="mailto:m_ferdji@estin.dz" style="color: #ffffff; text-decoration: none;">m_ferdji@estin.dz</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("🌐", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="#" target="_blank" style="color: #ffffff; text-decoration: none;">melissaferdji.me</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("⚡", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://github.com/FERDJImelissa" target="_blank" style="color: #ffffff; text-decoration: none;">github.com/FERDJImelissa</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("💼", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://linkedin.com/in/melissa-ferdji-41543336b" target="_blank" style="color: #ffffff; text-decoration: none;">linkedin.com/in/melissa-ferdji</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("╰────────────────────────────────────────╯", "#ff8c00")}`;
  ...
  initSnakeGame() {
    ...
    // Create canvas
    const canvasContainer = document.getElementById("snake-game-canvas");
    ...
    const resetGame = () => {
      ...
      this.gameInterval = setInterval(gameLoop, 1000 / frameRate);
    };
    ...
    const drawFood = () => {
      ...
      ctx.beginPath();
      ctx.arc(food.x * gridSize + gridSize / 2, food.y * gridSize + gridSize / 2, gridSize * 0.4, 0, Math.PI * 2);
      ctx.fill();
    };
    ...
    this.gameHandler = (e) => {
      ...
      if (e.keyCode === 38 && direction.y !== 1) { // UP
        nextDirection = { x: 0, y: -1 };
        e.preventDefault();
      } else if (e.keyCode === 40 && direction.y !== -1) { // DOWN
        nextDirection = { x: 0, y: 1 };
        e.preventDefault();
      } else if (e.keyCode === 37 && direction.x !== 1) { // LEFT
        nextDirection = { x: -1, y: 0 };
        e.preventDefault();
      } else if (e.keyCode === 39 && direction.x !== -1) { // RIGHT
        nextDirection = { x: 1, y: 0 };
        e.preventDefault();
    ...
    document.addEventListener("keydown", this.gameHandler);
    resetGame();
  }
  ...
  generateLinkedInCover(outputElement) {
    ...
    terminalTitle.textContent = "melissa@ferdji: ~/interactive-resume";
...
╚═╝     ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝╚═╝ ╚═════╝ `;
    ...
    url.textContent = "melissaferdji.me";
